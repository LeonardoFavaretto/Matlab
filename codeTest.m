...
function  resultado = modelo_funcao(p1,p2,p3,p4,p5,p6)
...
% Comparacao com serie empírica

eua0 = [8175133 3792621 2695598 2099451 1526006];
soma = sum(eua0);
eua = eua0/soma;
 
resultado = sum((abs((poploc0/100)- eua)));  

% =================================== Teste ponto inicial calibração
%options= optimset();
%n=20;
%parametros_teste = [ (0.04.*rand(1) + 0.04) 0.07*rand(1,1) (0.2.*rand(1)+ 0.2) (0.3.*rand(1) + 0.3) (30.*rand(1) + 10) (0.3.*rand(1) + 0.55)];
%for i=1:n
 %parametros_teste = [ (0.04.*rand(1) + 0.04) 0.07*rand(1,1) (0.2.*rand(1)+ 0.2) (0.3.*rand(1) + 0.3) (30.*rand(1) + 10) (0.3.*rand(1) + 0.55)]
%[letras,fmin] = fminsearch(@(x)modelo_funcao(p1,p2,p3,p4,p5,p6),parametros_teste, options)
%parametros_i(i,:)= letras;           %potencial criativo total
%erro_i(i,:) = fmin;
 %
%end
